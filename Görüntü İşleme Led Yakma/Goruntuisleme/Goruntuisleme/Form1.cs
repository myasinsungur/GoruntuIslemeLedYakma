            ...
            foreach (Rectangle recs in rects)
            {
                if (rects.Length > 0)
                {
                    ...
                    if(objectY < 80)
                    {
                        if(objectX < 107)
                        {
                            label3.Text = "1. Bölge";    serialPort1.Write("a");
                        }
                        else if(objectX > 213)
                        {
                            label3.Text = "3. Bölge";    serialPort1.Write("c");
                        }
                        else
                        {
                            label3.Text = "2. Bölge";    serialPort1.Write("b");
                        }
                    }
                    else if(objectY > 160)
                    {
                        if(objectX < 107)
                        {
                            label3.Text = "7. Bölge";    serialPort1.Write("g");
                        }
                        else if(objectX > 213)
                        {
                            label3.Text = "9. Bölge";    serialPort1.Write("i");
                        }
                        else
                        {
                            label3.Text = "8. Bölge";    serialPort1.Write("h");
                        }
                    }
                    else
                    {
                        if(objectX < 107)
                        {
                            label3.Text = "4. Bölge";    serialPort1.Write("d");
                        }
                        else if(objectX > 213)
                        {
                            label3.Text = "6. Bölge";    serialPort1.Write("f");
                        }
                        else
                        {
                            label3.Text = "5. Bölge";    serialPort1.Write("e");
                        }
                    }
